...
function PublicCard({ userId }) {
  ...
  if(!profile) return <div style={{minHeight:"100vh",background:"#060d1a",display:"flex",alignItems:"center",justifyContent:"center"}}><p style={{color:"#8fa3b8",fontFamily:"Sora,sans-serif"}}>Card not found.</p></div>;
      ...
      <div style={{maxWidth:960,margin:"0 auto",padding:"26px 20px"}}>
        ...
        {tab==="employees"&&<>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:9}}>
            {users.map(u=>{
              const cardUrl = u.customLink||`https://custera-ecard.netlify.app/?card=${u.id}`;
              return (
...
function EmployeeDashboard({ currentUser, onLogout, showToast }) {
  ...
  const cardUrl = profile.customLink||`${window.location.origin}/?card=${currentUser.uid}`;
      ...
      <div style={{maxWidth:900,margin:"0 auto",padding:"26px 20px",display:"grid",gridTemplateColumns:"1fr 1fr",gap:20}}>
        ...
        <div style={{display:"flex",flexDirection:"column",gap:14}}>
          ...
          <div style={{background:"rgba(255,255,255,0.04)",border:"1px solid rgba(255,255,255,0.07)",borderRadius:17,padding:18}}>
            ...
            <div style={{fontSize:11,color:"#6688ff",lineHeight:1.6,marginBottom:10,padding:"8px 10px",background:"rgba(26,62,212,0.08)",borderRadius:8,border:"1px solid rgba(26,62,212,0.2)"}}>
              Paste your Netlify URL here so QR codes point to the right page.
            </div>
            <div style={{display:"flex",gap:8,marginBottom:12}}>
              <input value={profile.customLink||""} onChange={e=>setProfile({...profile,customLink:e.target.value})}
                placeholder={`https://custera-ecard.netlify.app/?card=${currentUser.uid}`}
